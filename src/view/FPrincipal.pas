...
begin
  ...
  begin
    ...
    try
      frmVisualizarPedido.Pedido := Pedido;
      frmVisualizarPedido.ShowModal;
    finally
...
procedure TfrmPrincipal.btnRemoverPedidoClick(Sender: TObject);
begin
  var Pedido := PedidoSelecionado;
  if Assigned(Pedido) then
  begin
    ...
    begin
      FPedidoController.ExcluirPedido(Pedido);
      AtualizarGrid;
    end;
  end;
